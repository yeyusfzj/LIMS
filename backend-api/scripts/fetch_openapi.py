...
def fetch_and_save_openapi(base_url="http://localhost:8000"):
    """从运行中的服务获取并保存 OpenAPI 规范"""
    try:
        # 获取 OpenAPI 规范
        print(f"正在从 {base_url}/openapi.json 获取 OpenAPI 规范...")
...
```bash
curl -X GET {base_url}/api/v1/samples \\
...
if __name__ == "__main__":
    ...
    success = fetch_and_save_openapi(base_url)
